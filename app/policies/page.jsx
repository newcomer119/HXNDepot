                ...
                <div>
                  ...
                  <div className="prose max-w-none space-y-4">
                    <ul className="list-disc pl-6 space-y-2 text-gray-600">
                      ...
                      <li>For any issues or support regarding our services, customers can contact us at +1 (519) 706-6111 or email info@hxnbuildingdepot.ca.</li>
                    </ul>
                  </div>
                </div>
              )}
                  ...
                  <div className="prose max-w-none space-y-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <ul className="list-disc pl-6 mt-2 space-y-1 text-gray-600">
                          <li>📧 Email: info@hxnbuildingdepot.ca</li>
