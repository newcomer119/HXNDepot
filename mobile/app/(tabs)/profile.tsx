    ...
    <SafeScreen>
      ...
      >
        ...
        <View className="px-6 pb-8">
          <View className="bg-surface-light border border-surface-dark rounded-3xl p-6 shadow-sm">
            <View className="flex-row items-center">
              <View className="relative">
                <Image
                  ...
                  transition={200}
                />
                <View className="absolute -bottom-1 -right-1 bg-gold rounded-full size-7 items-center justify-center border-2 border-white">
                  <Ionicons name="checkmark" size={16} color="#005a2b" />
                </View>
              </View>
        ...
        <View className="flex-row flex-wrap gap-2 mx-6 mb-3">
          {MENU_ITEMS.map((item) => (
            <TouchableOpacity
              key={item.id}
              className="bg-surface-light border border-surface-dark rounded-2xl p-6 items-center justify-center shadow-sm"
              style={{ width: "48%" }}
              activeOpacity={0.7}
            ...
            >
              <View
                ...
                style={{ backgroundColor: "#005a2b20" }}
              >
                <Ionicons name={item.icon} size={28} color="#005a2b" />
              </View>
        ...
        {/* NOTIFICATONS BTN */}
        <View className="mb-3 mx-6 bg-surface-light border border-surface-dark rounded-2xl p-4 shadow-sm">
          <TouchableOpacity
            className="flex-row items-center justify-between py-2"
            activeOpacity={0.7}
          >
            <View className="flex-row items-center">
              <Ionicons name="notifications-outline" size={22} color="#005a2b" />
        ...
        <View className="mb-3 mx-6 bg-surface-light border border-surface-dark rounded-2xl p-4 shadow-sm">
          ...
          >
            <View className="flex-row items-center">
              <Ionicons name="shield-checkmark-outline" size={22} color="#005a2b" />
        ...
        {/* SIGNOUT BTN */}
        <TouchableOpacity
          className="mx-6 mb-3 bg-surface-light border-2 border-red-500/20 rounded-2xl py-5 flex-row items-center justify-center shadow-sm"
          activeOpacity={0.8}
          onPress={() => signOut()}
        >
